...
<h1>Modificacion Libros<?php echo (isset($aviso)?" - Libro Modificado":"")?></h1>
...
<form id="2" name="formulario" method="GET" action="productos_modificado.php">
	...
	<table class="tabla-form">
		<tr>
                    <td>ISBN:</td><td><input type="text" name="ISBN" size="30" value="<?php echo $fila['ISBN'];?>"></td>
		</tr>
		<tr>
                    <td>Nombre:</td><td><input type="text" name="nombre" size="100" value="<?php echo $fila['nombre'];?>"></td>
		</tr>
		<tr>
                    <td>Autor:</td><td><input type="text" name="autor" size="60" value="<?php echo $fila['autor'];?>"></td>
		</tr>
		<tr>
                    <td>Editorial:</td><td><input type="text" name="editorial" size="30" value="<?php echo $fila['editorial'];?>"></td>
		</tr>
	</table>
        <p class="p-abajo"><input class="guardar" type=submit value="Modificar Libro"></p>
</form>
</body>
</html>